...
public class ScoreController extends Controller {
    ...
    private List<CategoryModel> addRightCategories() {
        List<CategoryModel> categoryModels = new LinkedList<>();
        addRightCategory(new OfAKindCommand(2), categoryModels);
        addRightCategory(new OfTwoKindsCommand(2,2), categoryModels);
        ...
        addRightCategory(new OfTwoKindsCommand(3, 2), categoryModels);
